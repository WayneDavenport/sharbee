        ...
        <div className="h-full flex flex-col md:overflow-hidden">
            ...
            <form onSubmit={sendMessage} className="flex gap-2 shrink-0">
                ...
                <button
                    ...
                    className="shrink-0 px-4 sm:px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium flex items-center justify-center"
                >
                    {/* Icon on small screens, text on sm+ */}
                    <svg className="block sm:hidden w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
